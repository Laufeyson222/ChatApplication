            ...
            <div>
                <form>
                    <div className="formStyle">
                        <div>
                            <h1 style={{ marginTop: -100, marginBottom: 40, fontSize: 40, fontWeight: 'bolder', textAlign: "center", color: '#76ABAE' }}>Forgotpassword</h1>
                            {error && <div style={{ color: 'red', textAlign: 'center', marginBottom: '20px' }}>{error}</div>}
                            <div style={{ marginBottom: 40 }}>
                                <div>
                                    <label style={{ color: '#76ABAE' }}>Vui lòng nhập email hoặc username của bạn</label>
