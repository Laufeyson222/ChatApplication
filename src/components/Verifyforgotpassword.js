...
const Verifyforgotpassword = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            // Nếu xác thực thành công, chuyển hướng người dùng đến trang 'resetpassword'
        ...
        <div className="diagonalBackground">
            <div>
                <div style={{ position: 'relative' }}>
                    <h5 style={{ fontSize: 40, fontWeight: 'bolder', textAlign: "center" }}>OTP và password reset</h5>
                </div>
                    ...
                    <div className="formStyle">
                      <div>
                        ...
                        <div style={{width: 380, height: 50, marginRight: "8px", fontWeight: 'bold', borderRadius: 5 }}>
                            <label style={{fontSize:25,fontWeight:'bolder'}}>Password Reset</label>
                            <div style={{ justifyContent: 'center', alignItems: 'center', display: 'flex'}}>
                                <input
                                    value={password}
                                ...
                                <FontAwesomeIcon
                                            ...
                                            style={{ right: 10, cursor: 'pointer',color:'#76ABAE' }}
                                        />
                            </div>
                        </div>
